// Exibe o saldo total acumulado e quem está ganhando no dia.
...
export const OverallBalance: React.FC<OverallBalanceProps> = ({
  totalBalance,
  topGainer,
}) => {
  return (
      ...
      <div className={styles["top-gainer-container"]}>
        <div className={styles["top-gainer-info"]}>
          ...
          <div className={styles["gainer-row"]}>
            <span className={styles["gainer-name"]}>
              {topGainer?.name || "N/A"}
            </span>
            <span className={styles["gainer-change"]}>
              {topGainer
