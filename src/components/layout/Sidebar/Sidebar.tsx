  ...
  return (
    <nav className={styles.sidebar}>
      <div className={styles['nav-group']}>
        ...
        >
          <svg width="24" height="24" viewBox="0 0 32 40" fill={currentTab === 'favorites' ? "currentColor" : "none"} className={styles['nav-icon']} xmlns="http://www.w3.org/2000/svg">
            <path d="M26.7143 1C27.8509 1 28.941 1.44485 29.7447 2.23668C30.5485 3.02852 31 4.10247 31 5.2223V36.8895C30.9999 37.2592 30.9012 37.6224 30.7139 37.9428C30.5266 38.2631 30.2571 38.5294 29.9325 38.7149C29.608 38.9004 29.2396 38.9987 28.8644 39C28.4891 39.0012 28.1201 38.9054 27.7943 38.722L18.1257 33.2795C17.4783 32.9151 16.7456 32.7235 16 32.7235C15.2544 32.7235 14.5217 32.9151 13.8743 33.2795L4.20571 38.722C3.87987 38.9054 3.51087 39.0012 3.13562 39C2.76037 38.9987 2.39203 38.9004 2.06745 38.7149C1.74287 38.5294 1.47344 38.2631 1.28611 37.9428C1.09878 37.6224 1.00012 37.2592 1 36.8895V5.2223C1 4.10247 1.45153 3.02852 2.25526 2.23668C3.05898 1.44485 4.14907 1 5.28571 1H26.7143Z" stroke={currentTab === 'favorites' ? "currentColor" : "#CCCCCC"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </div>
