// Coração da aplicação: junta o estado global com o layout principal.
  ...
  useEffect(() => {
    const loadCoins = async () => {
      try {
        ...
        setError(
          "Fizemos muitas buscas rápidas! A API da CoinGecko pediu um pequeno descanso. Por favor, aguarde 1 minuto e recarregue a página",
        );
      } finally {
        setLoading(false);
      }
